    ...
    return (
        <section className="relative h-full overflow-hidden bg-white dark:bg-[#04040f]">
            <div className="relative z-10 flex h-full flex-col items-center justify-center gap-4 text-center">
                <p className="text-md font-light uppercase tracking-[0.4em] text-violet-500 dark:text-violet-400">
                    coming soon
                </p>
                <h1 className="text-7xl font-bold tracking-tight text-gray-900 dark:text-white md:text-6xl">
                    Under Construction
                </h1>
